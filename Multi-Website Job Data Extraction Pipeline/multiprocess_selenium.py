...
def run_ectarct(url_tag , url_id , url):
	...
	final_result['date_of_extract'] = final_result['date _of_extract'] + f_result['date _of_extract']
...
def thread_creater_and_extractor(user_id):
	global final_result
	final_result = {
		'job_id' : [] ,
        'title' : [],
	...
	urls = getting_user_info(user_id)
...
if __name__ == "__main__":
	#getting_user_info(1)	
	final_result = {}
	thread_creater_and_extractor(2)
